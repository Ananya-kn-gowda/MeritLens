...
const metadata = {
    ...
    description: 'An AI-powered evaluation platform that calculates a Grit Multiplier, adjusting raw scores by socioeconomic environment, school funding, and family income.',
    keywords: [
        'merit',
        'equity',
        'education',
